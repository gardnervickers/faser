...
//!
//! Faser utilizes a thread-per-core architecture where cross thread synchronization is
...
//!
//! To satisfy this, each Faser thread registers an eventfd read before sleeping on a ring. Other threads
